...
const LINUX_PATH = path.join(__dirname, './CHANGEME');
const WINDOWS_PATH = path.join(__dirname, './CHANGEME.exe');

module.exports = class CHANGEMEMiner {
    name = 'CHANGEME';
    ...
    start() {
        if (this._running) {
            console.info('CHANGEME already running');
            return;
        }
    ...
    _updateConfig() {
        ...
        this._app.logger.info('CHANGEME pools configuration');
